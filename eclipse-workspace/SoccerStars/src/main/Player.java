...
public class Player {
    ...
    private final double FORCE_MULTIPLIER = 0.2; // Factor para ajustar la velocidad general
    private final double COLLISION_ELASTICITY = 0.8; // Factor de rebote
 ...
 // Método para obtener la posición X
    ...
    public void update() {
        // Actualizar posición con valores enteros para evitar el efecto de "temblor"
        x += (int)velX;
        y += (int)velY;
